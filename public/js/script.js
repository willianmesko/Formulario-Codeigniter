$(document).ready(function(){
  ...
  //Valida os campos do formulário - Jquery Validate
  $("#formContato").validate({
    ...
    submitHandler: function(form) {
      notif({
        msg: "<b>Mensagem enviada com sucesso! </br>",
        type: "success",
        position :"center",
        animation:'slide'
        });
  ...
  //insere mascaras aos campos de telefone - jquery Mask
...
$(function(){
  $("#formContato").submit(function() { 
    ...
    $('#formContato input[type = submit]').val("Enviar"); 
  });
});
    
 /*Faz o select dinâmico das cidades relacionadas com o Estado 
      - Como não usei conexão com o banco de dados peguei um json na internet
  */
